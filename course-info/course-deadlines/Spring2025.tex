...
\begin{tabularx}{\textwidth}{|c|X|X|X|}
    ...
    \textcolor{red}{\textbf{Science knowledge survey (25 pts)}} &
    ...
    \textcolor{red}{\textbf{Problem 1: acceleration (25 pts)}} \\
    ...
    \cellcolor{gray!20}01/31/25  \newline
    
    \textbf{No Class: Spacetime Team Project}\newline\newline
    \textcolor{red}{\textbf{Problem 2: time dilation (25 pts)}}\\
    ...
    Gravitational waves \newline
    \textcolor{red}{\textbf{Exploration Paper 1: Space \& Time (25 pts)}} &
    
    02/05/25 \newline
    \newline
    The warp drive and "Future physics": \newline
    Quantum gravity \newline
    \textcolor{red}{\textbf{Spacetime Team Project (25 pts)}} &
    ...
    \textcolor{red}{\textbf{Problem 3: General relativity (25 pts)}}
    &
    ...
    \textcolor{red}{\textbf{Problem 4: matter \& materials (25 pts)}} \\
    \hline
    ...
    Chemical energy 
    \newline\newline
    \textcolor{red}{\textbf{Midterm Film Critique (50 pts)}}&
    ...
    \textcolor{red}{\textbf{Exploration Paper 2: Matter \& Energy (25 pts)}} \\
    \hline
\end{tabularx}
...
\begin{tabularx}{\textwidth}{|c|X|X|X|}
    ...
    \textcolor{red}{\textbf{Exploration Paper 3: AI (25 pts)}}
    &

    03/21/25 \newline
    \newline
    Crewed/un-crewed spaceflight\newline
    ...
    03/24/25 \newline
    \newline 
    Finding habitable planets continued\newline
    \newline
    ...
    \cellcolor{gray!20} 03/28/25 \newline
    \newline
    \textbf{No class: SETI Team Project} \newline\newline
    \textcolor{red}{\textbf{Exploration Paper 4: SETI (50 pts)}}
    \\
    ...
    \textcolor{red}{\textbf{SETI Team Project Due (25 pts)}}&
    
    

    \cellcolor{gray!20}04/04/25 \newline
    \newline
    \textbf{No Class: Spring Carnival}
    \\
    ...
    \textcolor{red}{\textbf{Exploration Paper 5: Being Human (25 pts)}}\\
    ...
    \textcolor{red}{\textbf{Final Film Critique (50 pts)}} &
